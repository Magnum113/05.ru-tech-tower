...
import UIOverlayDesignV2 from './components/UIOverlayDesignV2';
...
export default function AppDesignV2() {
  ...
  return (
    <div
      className="designv2 relative w-full h-screen overflow-hidden bg-[#15252B] select-none"
